...
class CalendarHeaderWidget extends StatelessWidget {
  ...
  const CalendarHeaderWidget({Key? key, required this.focusedDay}) : super(key: key);
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            nextMonth,
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.normal, color: Colors.grey[400]),
          ),
        ],
      ),
    );
